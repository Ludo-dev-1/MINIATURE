...
// Cette interface Database définit les opérations de base pour gérer les données dans l'application. 
// Elle permet d'ajouter, de supprimer, de trouver et de récupérer des éléments de différents types (comme User et Post) en utilisant des prédicats pour filtrer les résultats.
// Les méthodes sont génériques, ce qui permet de les utiliser pour différents types d'entités sans avoir à dupliquer le code pour chaque type.
