...
public class RegisterService {
    ...
    // Le service d'enregistrement gère le processus d'inscription des nouveaux utilisateurs.
    //  Il vérifie que les données fournies sont valides et que le nom d'utilisateur n'est pas déjà pris avant de créer un nouvel utilisateur et de le sauvegarder dans le UserRepository.
