...
// La méthode getPostsForUser enrichit les posts avec des informations sur l'auteur, si l'utilisateur suit l'auteur, et si l'utilisateur a aimé le post. 
// Les posts sont ensuite triés par date de création.
